...
public class Pano0307SearchService extends BaseService {
   ...
   */
  public EasyJson<Object> doSearchExpositionMap(Pano0307Form inForm) throws Exception {
    ...
    List<PanoPanorama01Model> panoPanoramaList =
        panoPanorama01Mapper.selectMapHotspotPanorama(conditions);
