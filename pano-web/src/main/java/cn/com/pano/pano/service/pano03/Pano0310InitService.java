...
public class Pano0310InitService extends BaseService {
   ...
   * @throws Exception
   */
  public void doInit(Pano0310Form _inForm) throws Exception {

    if (!ObjectUtils.isEmpty(_inForm. pano0310panoramaId)) {
      PanoPanorama panorama = panoPanorama01Mapper.selectByPrimaryKey(_inForm. pano0310panoramaId);
      _inForm. pano0310panoramaPath = MessageFormat.format(PanoConstantsIF.VAL_APP_SERVER_W_PANORAMA,
          panorama.expositionId, panorama.panoramaPath);
      // _inForm. pano0310panoramaPath = _inForm. pano0310panoramaPath.replace("show.xml",
      // "popup_show.xml");
      _inForm. pano0310panoramaPath = _inForm. pano0310panoramaPath + "/popup_show.xml";
      // 全景图文件取得
      String _srcPath = MessageFormat.format(PanoConstantsIF.VAL_PUBLIC_DIRECTORY_W_PANORAMA,
          panorama.expositionId, _inForm. pano0310panoramaId + "/");
    ...
    String xmlFilePath = FwFileUtils.getAbsolutePath(_inForm. pano0310panoramaPath);
    ...
    Pano0310Form  pano0310FormInfo = MusicHostspotInfo(_inForm);
    String fisrtMaterialUrl = "../../../../" +  pano0310FormInfo.firstImageInfo.hotspotImagePath;
    String secondMaterialUrl = "../../../../" +  pano0310FormInfo.secondImageInfo.hotspotImagePath;
    String soundpath = "";
    String othersoundpath = "";

    PanoPanoramaHotspot hotspot =
        panoPanoramaHotspot01Mapper.selectByPrimaryKey(_inForm. pano0310selectedHotspotId);
   ...
   * @throws Exception
   */
  public Pano0310Form MusicHostspotInfo(Pano0310Form _inForm) throws Exception {
    Pano0104Dto  pano0104Dto = new Pano0104Dto();
    PanoPanoramaHotspot hotspotInfo =
        panoPanoramaHotspot01Mapper.selectByPrimaryKey(_inForm. pano0310selectedHotspotId);
     pano0104Dto.hotspotScale = hotspotInfo.hotspotScale;
     pano0104Dto.hotspotAth = hotspotInfo.hotspotAth;
     pano0104Dto.hotspotAtv = hotspotInfo.hotspotAtv;
     pano0104Dto.hotspotImageId = hotspotInfo.hotspotImageId;
    //
    String fisrtMaterialId = "";
    String secondMaterialId = "";
    HashMap<String, Object> condition = Maps.newHashMap();
    condition.put("hotspotId", _inForm. pano0310selectedHotspotId);
      ...
      for (PanoHotspotUrl urlInfo : hotspotUrl) {
        if (!"0".equals(urlInfo.sortKey.toString())) {
          if (urlInfo.hotspotUrlObjectId.equals(panoPanoramaHotspot01Mapper
              .selectByPrimaryKey(_inForm. pano0310selectedHotspotId).hotspotImageId)) {
    ...
    if (!ObjectUtils.isEmpty(fisrtMaterialId)) {
      ...
      PanoMaterial material = panoMaterial01Mapper.selectByPrimaryKey(fisrtMaterialId);
       pano0104Dto.hotspotImagePath = material.materialPath;
      if (material != null && !ObjectUtils.isEmpty(material.gifDelayTime)) {
         pano0104Dto.gifWidth = material.gifWidth;
         pano0104Dto.gifHeight = material.gifHeight;
         pano0104Dto.gifFrameCount = material.gifFrameCount;
         pano0104Dto.gifDelayTime = material.gifDelayTime;
         pano0104Dto.hasPngImage = "true";

      }
       pano0104Dto.hotspotImagePath = MessageFormat.format(PanoConstantsIF.VAL_APP_SERVER_W_TEMP_IMAGE,
          PanoConstantsIF.MATERIAL_FOLDER_NAME + material.expositionId,  pano0104Dto.hotspotImagePath);
      ...
      String destPath = MessageFormat.format(PanoConstantsIF.VAL_APP_SERVER_W_IMAGE,
          PanoConstantsIF.MATERIAL_FOLDER_NAME + material.expositionId, material.materialId + "/");
      FileServiceUtil.copyDirFromPublicStorageToAppServer(srcPath, destPath);
      _inForm.firstImageInfo =  pano0104Dto;
    }

    Pano0104Dto  pano0104Dto_2 = new Pano0104Dto();
     pano0104Dto_2.hotspotScale = hotspotInfo.hotspotScale;
     pano0104Dto_2.hotspotAth = hotspotInfo.hotspotAth;
     pano0104Dto_2.hotspotAtv = hotspotInfo.hotspotAtv;
     pano0104Dto_2.hotspotImageId = hotspotInfo.hotspotImageId;
    // 音频热点第二张图的信息
    if (!ObjectUtils.isEmpty(secondMaterialId)) {
       pano0104Dto_2.hasPngImage = "false";
      PanoMaterial material = panoMaterial01Mapper.selectByPrimaryKey(secondMaterialId);
       pano0104Dto_2.hotspotImagePath = material.materialPath;
      if (material != null && !ObjectUtils.isEmpty(material.gifDelayTime)) {
         pano0104Dto_2.gifWidth = material.gifWidth;
         pano0104Dto_2.gifHeight = material.gifHeight;
         pano0104Dto_2.gifFrameCount = material.gifFrameCount;
         pano0104Dto_2.gifDelayTime = material.gifDelayTime;
         pano0104Dto_2.hasPngImage = "true";

      }
       pano0104Dto_2.hotspotImagePath =
      ...
      String destPath = MessageFormat.format(PanoConstantsIF.VAL_APP_SERVER_W_IMAGE,
          PanoConstantsIF.MATERIAL_FOLDER_NAME + material.expositionId, material.materialId + "/");
      FileServiceUtil.copyDirFromPublicStorageToAppServer(srcPath, destPath);
      _inForm.secondImageInfo =  pano0104Dto_2;
    }
    return _inForm;
  }
