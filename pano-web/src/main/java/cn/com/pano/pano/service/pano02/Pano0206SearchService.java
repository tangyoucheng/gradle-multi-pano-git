...
import cn.com.pano.pano.mapper.pano02.Pano0206Mapper;
...
public class Pano0206SearchService extends BaseService {
  @Autowired
  public Pano0206Mapper  pano0206Mapper;
   ...
   * @throws Exception
   */
  public String searchMaterial(Pano0206Form _inForm) throws Exception {
    String searchResult = "";
    // 从数据库中检索场景信息
    ...
    // 场景详细信息取得
    int count =  pano0206Mapper.selectPanoramaInfoCount(condition);
    checkCount(_inForm, count);
    _inForm.panoramaInfo =  pano0206Mapper.selectPanoramaInfo(condition);
