...
public class PanoVr0104Form extends AbstractForm implements Serializable {

  private static final long serialVersionUID = 1L;
  public String spotInfoListJson;
  // 热点结果集
  public List<PanoVr0104Dto> spotInfoList;
  // 被选中的全景图上的热点ID
  ...
  /* 展览ID 检索条件 */
  public String condition_expositionId;
  /* 展览名称 检索条件 */
  public String condition_expositionName;
  // 展览下是否有地图
  ...
  // 判断是否由 pano0110画面跳至icvr0104画面，如果是，保存pageStartRowno
