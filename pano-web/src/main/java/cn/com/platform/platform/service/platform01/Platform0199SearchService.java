 ...
 */
@Service
public class Platform0199SearchService extends BaseService {
  /** 自定义SQL */
  @Autowired
  PlatformDepartment01Mapper platformzDepartment01Mapper;

  public EasyJson<PlatformDepartment01Model> doSearch(Platform0199Form inForm) {
...
//    easyJson.setTotal(inForm.recordCount);
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platform0199Form inForm) {
