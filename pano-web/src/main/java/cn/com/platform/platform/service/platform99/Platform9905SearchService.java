 ...
 */
@Service
public class Platform9905SearchService extends BaseService {

  @Autowired
  PlatformJobCron01Mapper platformJobCron01Mapper;

  public EasyJson<PlatformJobCron01Model> doSearch(Platform9905Form inForm) {
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platform9905Form inForm) {
