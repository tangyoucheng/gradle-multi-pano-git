...
public class Platformz0199DeleteService extends BaseService {
   ...
   * 删除。
   * 
   * @param inForm Platformz0199Form
   * @throws SystemException 异常的场合
   */
  public EasyJson<PlatformDepartment> doDelete(Platformz0199Form inForm) throws SystemException {
