 ...
 */
@Service
public class Platformz9906SearchService extends BaseService {

  @Autowired
  PlatformJobRepeat01Mapper platformJobRepeat01Mapper;

  public EasyJson<PlatformJobRepeat01Model> doSearch(Platformz9906Form inForm) {
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz9906Form inForm) {
