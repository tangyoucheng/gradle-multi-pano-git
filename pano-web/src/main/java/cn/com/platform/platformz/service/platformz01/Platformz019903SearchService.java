 ...
 */
@Service
public class Platformz019903SearchService extends BaseService {
  /** 自定义SQL */
  @Autowired
  PlatformDepartment01Mapper platformzDepartment01Mapper;

  public EasyJson<PlatformDepartment01Model> doSearch(Platformz019903Form inForm) {
...
//    easyJson.setTotal(inForm.recordCount);
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz019903Form inForm) {
