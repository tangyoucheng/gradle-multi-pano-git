 ...
 */
@Service
public class Platformz9905RunService extends BaseService {
  ...
  public EasyJson<PlatformJobCron> doRun(Platformz9905Form inForm) {
    ...
    if (!ObjectUtils.isEmpty(inForm.uniqueKeyList)) {
      for (Object JobId : inForm.uniqueKeyList) {
        ...
        if (platformJobCron != null) {
          ...
          CronScheduleUtils.run(scheduler, cronJob);
        }
      }
    }
