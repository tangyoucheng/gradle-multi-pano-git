 ...
 */
@Service
public class Platformz0202SearchService extends BaseService {

  @Autowired
  PlatformRole01Mapper platformzRole01Mapper;

  public EasyJson<PlatformRole> doSearch(Platformz0202Form inForm) {

    // SQL文的参数
    HashMap<String, Object> parameter = new HashMap<String, Object>();
    // 公司角色
    parameter.put("roleName", inForm.getRoleName());
    // 删除标识
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz0202Form inForm) {
