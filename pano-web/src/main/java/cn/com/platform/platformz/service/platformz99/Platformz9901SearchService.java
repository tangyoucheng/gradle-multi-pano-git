 ...
 */
@Service
public class Platformz9901SearchService extends BaseService {

  @Autowired
  PlatformOnlineUser01Mapper platformOnlineUser01Mapper;

  public EasyJson<PlatformOnlineUser> doSearch(Platformz9901Form inForm) {
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz9901Form inForm) {
