 ...
 */
@Service
public class Platformz990501InitService extends BaseService {

  @Autowired
  PlatformJobCron01Mapper platformJobCron01Mapper;

  public void doInit(Platformz990501Form inForm) {

    if (!ObjectUtils.isEmpty(inForm.jobId)) {
      // 检索job信息
      PlatformJobCron platformJobCron = platformJobCron01Mapper.selectByPrimaryKey(inForm.jobId);
