 ...
 */
@Service
public class Platformz0102SearchService extends BaseService {
   ...
   * @return
   */
  public EasyJson<PlatformRole> doSearch(Platformz0102Form inForm) {
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz0102Form inForm) {
