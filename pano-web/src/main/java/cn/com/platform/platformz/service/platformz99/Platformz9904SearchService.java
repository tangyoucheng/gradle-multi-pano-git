 ...
 */
@Service
public class Platformz9904SearchService extends BaseService {
   ...
   * 用户登陆日志检索
   * 
   * @param inForm Platformz9904Form
   * @return
   */
  public EasyJson<PlatformLoginInfo> doSearch(Platformz9904Form inForm) {
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz9904Form inForm) {
