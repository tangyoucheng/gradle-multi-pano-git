 ...
 */
@Service
public class Platformz9907SearchService extends BaseService {

  @Autowired
  PlatformJobLog01Mapper platformJobLog01Mapper;

  public EasyJson<PlatformJobLog> doSearch(Platformz9907Form inForm) {
   ...
   * @return 排序信息
   */
  private String getOrderInfo(Platformz9907Form inForm) {
