 ...
 */
    ...
    function clone(configObject) {
        ...
        convertBase = ( function () {
            ...
            // If the caller is toString, we are converting form base 10 to baseOut.
            // If the caller is BigNumber, we are converting form baseIn to base 10.
        ...
        div = (function () {
            ...
            return function ( x, y, dp, rm, base ) {
                ...
                // The coefficients of the BigNumbers form convertBase may have trailing zeros.
                ...
                if ( s < 0 ) {
                    ...
                    do {
                        ...
                        if ( cmp < 0 ) {
                            ...
                            // Subtract product form remainder.
                            ...
                            if ( cmp == -1 ) {
                                ...
                                // If divisor < new remainder, subtract divisor form remainder.
                                // Trial digit n too low.
                                // n is 1 too low about 5% of the time, and very rarely 2 too low.
                                while ( compare( yc, rem, yL, remL ) < 1 ) {
                                    n++;

                                    // Subtract divisor form remainder.
