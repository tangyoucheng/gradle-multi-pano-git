var vr0108Interval = setInterval(function(){loadHotspotInfo();},1000);
...
$(document).ready(function(){
    ...
    $('#save-button').click(function() {
        imuiConfirm('是否录入热点?', '确认', function() {
            ...
            var hotspotInfoList = [];
            var krpano = document.getElementById("vr0108KrpanoSWFObject");
...
function loadHotspotInfo() {
    ...
    $(spotInfoList).each(function(index, hotspotData){
        ...
        krpano.set('hotspot['+newspot+'].onclick','js(vr0108RemoveHotspot(get(name));)');
...
//删除热点
function vr0108RemoveHotspot(_hotspotName) {
