...
(function ($) {
  ...
  /**
   * Remove all diatrics form the given text.
   * @access private
   * @param {String} text
   * @returns {String}
   */
  ...
  var Selectpicker = function (element, options) {
    ...
    // If we have no title yet, try to pull it form the html title attribute (jQuery doesnt' pick it up as it's not a
    // data-attribute)
  ...
  Selectpicker.prototype = {
    ...
    setMenuSize: function (isAuto) {
      ...
      if (this.dropdown && this.dropdown._popper) this.dropdown._popper.updateByPrimaryKey();
    },
    ...
    setWidth: function () {
      ...
      if (this.options.width === 'auto') {
        ...
        // Remove inline min-width so width can be changed form 'auto'
    ...
    keydown: function (e) {
      ...
      if (
        ...
        if (!that.options.liveSearch || e.which !== keyCodes.SPACE) {
          ...
          if (!that.options.liveSearch) {
            // Prevent screen form scrolling if the user hits the spacebar
            e.preventDefault();
  ...
  function Plugin(option) {
    ...
    var args = arguments;
    // The arguments of the function are explicitly re-defined form the argument list, because the shift causes them
