...
$.fn.EZView = function(filePaths) {
    var self             = this,
        ...
        icons            = {
            ...
            'download' : 'data:image/png;base64,',
        ...
        if (!$('#EZView').length) {
            ...
            var tools = 
                '<div class="tools-container">'+
                    ...
                    '</spam>'+
                    '<a class="viewClose EZViewHighlight" href="">'+
                    '<img src="'+icons.viewClose+'"/></a>'+
                '</div>',
                container = '<div class="object-container"/>'+
                        ...
                        tools,
                template = '<div id="EZView" class="hide containerDiv" style="display: flex; align-items: center; justify-content: center">'+container+'</div>';
    ...
    self.builtObjectTemplate = function(index) {
		...
		var iframeSrc = getContextPath('static/framework/plugins/sh-gallery/jquery-photo-gallery/gallery.html?imagePath='+src);
        var content = '<iframe frameborder="0" index-render="'+index+'" height="'+($(window).height()-35)*0.95+'" width="'+$(window).width()*0.9+
                '" src="'+iframeSrc+'"><p>Your browser does not support iframes.</p>'+
                '<script type="text/javascript">iFramesSupported = false; alert(iFramesSupported)</script><iframe/>';
        
        // To show pdf files
        if (isPdf) {
            content = '<iframe frameborder="0" index-render="'+index+'" height="'+($(window).height()-35)*0.95+'" width="'+$(window).width()*0.9+
...
//            'height':   '38px',
    ...
    self.addEvents = function() {
        ...
        // Add close Event
        .find('.viewClose>img').click(function(e) {
            e.preventDefault();
            e.stopPropagation();
            self.close();
        }).end()
        ...
        // Add prevent default
        .find('.zoomin, .zoomout, .viewClose').click(function(e) {
            e.stopPropagation();
            e.preventDefault();
        }).end()
    ...
    self.goTo = function(newIndex) {
        ...
        if (arIndex[newIndex]) {
            ...
            if (arIndex[newIndex].isRender) {
                $('[index-render='+index+']').hide();
                $('[index-render='+newIndex+']').show();
                self.showOrHideControls(newIndex);
            }else{
                $('[index-render='+index+']').hide();
                self.setObjectTemplate(self.builtObjectTemplate(newIndex));
                $('[index-render='+newIndex+']').hide().show();
	...
	// 初始化
    jQuery.each(filePaths, function(i, item) {
