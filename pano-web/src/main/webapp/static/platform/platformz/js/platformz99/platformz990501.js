...
$(function() {
    ...
    $("#btn_entry").click(function() {
        ...
        // 统一移除popover提示消息层
        $("#Platformz990501Form").validate().destroy();
        // validate初始化
        $("#Platformz990501Form").validate();
        ...
        // 按钮
            ...
            var targetUrl = 'Platformz990501/doEntry';
            var formData = form2js($("#Platformz990501Form")[0]);
            $.ajax({
                type : 'post',
                traditional : true,
                data : formData,
    ...
    // 触发器设定 日期设定
    $("#Platformz990501_cron").click(function() {
        var targetUrl = 'Platformz99050101/';
    ...
    // 触发器设定 重复设定
    $("#Platformz990501_repeat").click(function() {
        var targetUrl = 'Platformz99050102/';
        targetUrl = targetUrl + '?returnTargetIframe=' + window.name + '&jobId=' + $('#txt_jobId').val();
        window.top.layer.open({
            title : '触发器设定',
            type : 2,
