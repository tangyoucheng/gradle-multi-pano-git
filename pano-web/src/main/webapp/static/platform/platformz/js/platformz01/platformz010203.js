...
$(function() {
    ...
    $('#platformz010203Btn_selected').prop('disabled', !selectionsLength);
    ...
    // 选择处理
    $('#platformz010203Btn_selected').click(function() {
        var returnObject = [];
        var recoedObject = {};
        ...
        // 选中的值传给前页面
        window.parent.frames[$('#returnTargetIframe').val()].setCisz010203ReturnObject(returnObject);
        // 自页面关闭
...
function searchData() {
    ...
    $('#table-rolesInfo').bootstrapTable({
        url : getMemberContextPath('platformz010203/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platformz010203FormSearch")[0]);
