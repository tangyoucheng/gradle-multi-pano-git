...
$(function() {
    ...
    $('#Platformz9905Btn_delete').prop('disabled', !selectionsLength);
    $('#Platformz9905Btn_resume').prop('disabled', !selectionsLength);
    $('#Platformz9905Btn_pause').prop('disabled', !selectionsLength);
    $('#Platformz9905Btn_run').prop('disabled', !selectionsLength);
    ...
    // 检索
    $("#Platformz9905Btn_query").click(function() {
        searchData();
    });
    ...
    // 新建
    $("#Platformz9905Btn_new").click(function() {
        var targetUrl = 'Platformz990501/';
    ...
    // 删除
    $("#Platformz9905Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#Platformz9905FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getMemberContextPath('Platformz9905/doDelete'),
    ...
    // 恢复
    $("#Platformz9905Btn_resume").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getMemberContextPath('Platformz9905/doResume'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
    ...
    // 暂停
    $("#Platformz9905Btn_pause").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getMemberContextPath('Platformz9905/doPause'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
    ...
    // 执行一次
    $("#Platformz9905Btn_run").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getMemberContextPath('Platformz9905/doRun'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
...
function searchData() {
    ...
    // 初始化表格,动态从服务器加载数据
    tableJobList.bootstrapTable({
        url : getMemberContextPath('Platformz9905/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#Platformz9905FormSearch")[0]);
