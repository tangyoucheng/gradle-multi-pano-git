...
$(function() {
    ...
    $('#Platformz9907Btn_delete').prop('disabled', !selectionsLength);
    ...
    // 检索
    $("#Platformz9907Btn_query").click(function() {
        searchData();
    });
    ...
    // 删除
    $("#Platformz9907Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#Platformz9907FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getMemberContextPath('Platformz9907/doClean'),
    ...
    // 清空
    $("#Platformz9907Btn_clean").click(function() {
        // 询问框
           ...
           // 按钮
               ...
               $.ajax({
                   ...
                   data : ajaxSubmitFormData,
                   dataType : 'json',
                   url : getMemberContextPath('Platformz9907/doDelete'),
                   success : function(result) {
                       if (result.success) {
                           window.top.layer.alert(result.msg, function(index) {
                               // 关闭当前层
...
function searchData() {
    ...
    // 初始化表格,动态从服务器加载数据
    tableJobLogList.bootstrapTable({
        url : getMemberContextPath('Platformz9907/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#Platformz9907FormSearch")[0]);
