...
$(function() {
    ...
    $('#platformz0202Btn_delete').prop('disabled', !selectionsLength);
    ...
    // 新建
    $("#platformz0202Btn_new").click(function() {
        var targetUrl = 'platformz020201/';
    ...
    // 删除
    $("#platformz0202Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#platformz0202FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getMemberContextPath('platformz0202/doDelete'),
    ...
    searchData();
    // 检索
    $("#platformz0202Btn_query").click(function() {
        // debugger; 检测
        searchData();
    });
});
...
function searchData() {
    ...
    $('#table-rolesInfo').bootstrapTable({
        url : getMemberContextPath('platformz0202/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platformz0202FormSearch")[0]);
