...
$(function() {
    ...
    $('#platformz019903Btn_selected').prop('disabled', !selectionsLength);
    ...
    // 选择处理
    $('#platformz019903Btn_selected').click(function() {
        var returnObject = [];
        var recoedObject = {};
        ...
        // 选中的值传给前页面
        window.parent.frames[$('#returnTargetIframe').val()].setCisz019903ReturnObject(returnObject);
        // 自页面关闭
...
function searchData() {
    ...
    $('#table-departmentInfo').bootstrapTable({
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platformz019903FormSearch")[0]);
