...
$(function() {
    ...
    $('#Platformz9901Btn_forceLogout').prop('disabled', !selectionsLength);
    ...
    // 检索
    $("#Platformz9901Btn_query").click(function() {
        searchData();
    });

    // 强退
    $("#Platformz9901Btn_forceLogout").click(
        function() {
            ...
            // 按钮
                ...
                // 表单数据转换成JS对象
                var ajaxSubmitFormData = $("#Platformz9901FormAjaxSubmit").serialize() + '&'
                ...
                $.ajax({
                    ...
                    dataType : 'json',
                    url : getMemberContextPath('Platformz9901/doForceLogout'),
...
function searchData() {
    ...
    // 初始化表格,动态从服务器加载数据
    tableOnlineUser.bootstrapTable({
        url : getMemberContextPath('Platformz9901/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#Platformz9901FormSearch")[0]);
