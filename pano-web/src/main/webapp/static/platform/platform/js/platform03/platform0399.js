...
$(function() {
    var tableAdminInfo = $('#table-companyInfo');
    ...
    $('#platform0399Btn_delete').prop('disabled', !selectionsLength);
    ...
    // 新建
    $("#platform0399Btn_new").click(function() {
        var targetUrl = 'platform039901/';
    ...
    // 删除
    $("#platform0399Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#platform0399FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getAdminContextPath('platform0399/doDelete'),
    ...
    searchData();
    // 检索
    $("#platform0399Btn_query").click(function() {
        // debugger; 检测
        searchData();
    });
});
...
function searchData() {
    ...
    $('#table-companyInfo').bootstrapTable({
        url : getAdminContextPath('platform0399/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platform0399FormSearch")[0]);
