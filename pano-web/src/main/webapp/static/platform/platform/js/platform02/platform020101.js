...
$(function() {
    ...
    // 角色添加处理
    $('#platform020101Btn_addRole').click(function() {
    ...
    // 角色删除处理
    $('#platform020101Btn_deleteRole').click(function() {
    ...
    $("#btn_entry").click(function() {
        ...
        // 统一移除popover提示消息层
        $("#platform020101Form").validate().destroy();
        // validate初始化
        $("#platform020101Form").validate();
        // $("#txt_bankNameCn").attr('required', '');
        // $("#txt_bankNameEn").attr('required', '');
        // $("#txt_bankCode").attr('required', '');
        // 有验证错误时返回
        if (!$("#platform020101Form").valid()) {
            return;
        }
        ...
        // 按钮
            ...
            var targetUrl = 'platform020101/doEntry';
            var formData = form2js($("#platform020101Form")[0]);
            $.ajax({
                type : 'post',
                traditional : true,
                data : formData,
