...
$(function() {
    ...
    $('#platform0199Btn_delete').prop('disabled', !selectionsLength);
    ...
    // 新建
    $("#platform0199Btn_new").click(function() {

        var targetUrl = 'platform019901/';
        ...
        window.top.layer.open({
            ...
            closeBtn : 1, // 显示关闭按钮
            area : [ '90%', '90%' ], // 宽高
            content : [ getAdminContextPath(targetUrl), 'yes' ],// iframe层出现滚动条
            end : function() {
                searchData();
            }
        });
    ...
    // 删除
    $("#platform0199Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#platform0199FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getAdminContextPath('platform0199/doDelete'),
    ...
    searchData();
    // 检索
    $("#platform0199Btn_query").click(function() {
        // debugger; 检测
        searchData();
    });
});
...
function searchData() {
    ...
    $('#table-departmentInfo').bootstrapTable({
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platform0199FormSearch")[0]);
