...
$(function() {
    ...
    $("#btn_entry").click(function() {
        ...
        // 统一移除popover提示消息层
        $("#platform990601Form").validate().destroy();
        // validate初始化
        $("#platform990601Form").validate();
        ...
        // 按钮
            ...
            var targetUrl = 'platform990601/doEntry';
            var formData = form2js($("#platform990601Form")[0]);
            $.ajax({
                type : 'post',
                traditional : true,
                data : formData,
    ...
    // 触发器设定 日期设定
    $("#platform990601_cron").click(function() {
        var targetUrl = 'platform99060101/';
    ...
    // 触发器设定 重复设定
    $("#platform990601_repeat").click(function() {
        var targetUrl = 'platform99060102/';
        targetUrl = targetUrl + '?returnTargetIframe=' + window.name + '&jobId=' + $('#txt_jobId').val();
        window.top.layer.open({
            title : '触发器设定',
            type : 2,
