...
$(function() {
    ...
    $('#platform9906Btn_delete').prop('disabled', !selectionsLength);
    $('#platform9906Btn_resume').prop('disabled', !selectionsLength);
    $('#platform9906Btn_pause').prop('disabled', !selectionsLength);
    $('#platform9906Btn_run').prop('disabled', !selectionsLength);
    ...
    // 检索
    $("#platform9906Btn_query").click(function() {
        searchData();
    });
    ...
    // 新建
    $("#platform9906Btn_new").click(function() {
        var targetUrl = 'platform990601/';
    ...
    // 删除
    $("#platform9906Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#platform9906FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getAdminContextPath('platform9906/doDelete'),
    ...
    // 恢复
    $("#platform9906Btn_resume").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getAdminContextPath('platform9906/doResume'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
    ...
    // 暂停
    $("#platform9906Btn_pause").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getAdminContextPath('platform9906/doPause'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
    ...
    // 执行一次
    $("#platform9906Btn_run").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getAdminContextPath('platform9906/doRun'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
...
function searchData() {
    ...
    // 初始化表格,动态从服务器加载数据
    tableJobList.bootstrapTable({
        url : getAdminContextPath('platform9906/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platform9906FormSearch")[0]);
        ...
        columns : [ {
            ...
            formatter : function(value, tableRowInfo, index) {
                ...
                showData = showData + ' class="btn platform-btn-blue font-12 p-1 row-edit"';
                showData = showData + '>';
