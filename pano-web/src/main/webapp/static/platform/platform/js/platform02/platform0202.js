...
$(function() {
    ...
    $('#platform0202Btn_delete').prop('disabled', !selectionsLength);
    ...
    // 新建
    $("#platform0202Btn_new").click(function() {
        var targetUrl = 'platform020201/';
    ...
    // 删除
    $("#platform0202Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#platform0202FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getAdminContextPath('platform0202/doDelete'),
...
function searchData() {
    ...
    $('#table-rolesInfo').bootstrapTable({
        url : getAdminContextPath('platform0202/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platform0202FormSearch")[0]);
