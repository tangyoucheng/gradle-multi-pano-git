...
$(function() {
    ...
    $('#platform9904Btn_delete').prop('disabled', !selectionsLength);
    ...
    // 检索
    $("#platform9904Btn_query").click(function() {
        searchData();
    });

    // 删除
    $("#platform9904Btn_delete").click(function() {
        ...
        // 按钮
            ...
            // 表单数据转换成JS对象
            var ajaxSubmitFormData = form2js($("#platform9904FormAjaxSubmit")[0]);
            ...
            $.ajax({
                ...
                dataType : 'json',
                url : getAdminContextPath('platform9904/doDelete'),
    ...
    // 清空
    $("#platform9904Btn_clear").click(function() {
        ...
        // 按钮
            ...
            $.ajax({
                ...
                data : ajaxSubmitFormData,
                dataType : 'json',
                url : getAdminContextPath('platform9904/doClear'),
                success : function(result) {
                    if (result.success) {
                        window.top.layer.alert(result.msg, function(index) {
                            // 关闭当前层
...
function searchData() {
    ...
    // 初始化表格,动态从服务器加载数据
    tableLoginInfo.bootstrapTable({
        url : getAdminContextPath('platform9904/doSearch'), // 请求后台的URL（*）
        method : 'get', // 请求方式（*）
        ...
        queryParams : function queryParams(params) { // 设置查询参数
            // 表单数据转换成JS对象
            var formData = form2js($("#platform9904FormSearch")[0]);
