...
$(function() {
    $('#btn_update').click(function() {
        ...
        // 按钮
            ...
            var formData = form2js($("#ps990101Form")[0]);
            $.ajax({
                url : getAdminContextPath('ps99/ps990101/doUpdate'),
                type : "post",
                dataType : "json",
                data : formData,
