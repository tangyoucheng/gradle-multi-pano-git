...
<script src="static/platform/platformz/js/platformz01/platformz010201.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form action="/" modelAttribute="platformz010201Form" class="form-horizontal">
                    <!-- 角色名 -->
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txt_roleName" name="roleName"
                                value="${platformz010201Form.roleName}" maxlength="255" required="required">
                        </div>
                    </div>
                    <div class="form-row">
