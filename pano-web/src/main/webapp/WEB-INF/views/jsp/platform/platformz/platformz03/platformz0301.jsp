...
<script src="static/platform/platformz/js/platformz03/platformz0301.js"></script>
</head>
<body>
    <div class="card-body">
        <!-- 检索条件 -->
        <form:form id="platformz0301FormSearch" action="/" modelAttribute="platformz0301Form" style="width:100%">
            <div class=" card-body form-row bg-white mb-3 m-0">
                ...
                <div class=" col-sm-2 form-row  button-group justify-content-end">
                    <button type="button" id="platformz0301Btn_query" class="btn cis-btn cis-btn-primary mr-2">
                        <span>查询</span>
                    </button>
                    <button type="button" id="platformz0301Btn_clean" class="btn cis-btn cis-btn-white">
                        <span>清空</span>
                    </button>
                </div>
            </div>
        ...
        <div class="card-body bg-white pt-2 position-relative">
            <div id="toolbar" class="">
                <button id="platformz0301Btn_new" type="button" class="btn cis-btn cis-btn-primary mr-2">
                ...
                <div class="btn-group cis-btn-dropdown form-row m-0">
                    ...
                    <ul class="dropdown-menu mt-2">
                        <li class="dropdown-item" id="platformz0301Btn_delete">
                            <span>删除 </span>
                        </li>
                    </ul>
                </div>
            </div>
            <table id="table-serverTypeIdInfo" data-toolbar="#toolbar">
                <thead>
                    <tr>
                        <th data-field="checkbox" data-checkbox="true" data-halign="center" data-align="center"></th>
                        <th data-field="serverTypeId" data-visible="false">ID</th>
    ...
    <!-- Ajax提交用的Form -->
    <form:form id="platformz0301FormAjaxSubmit" action="/" modelAttribute="platformz0301Form">
    </form:form>
</body>
</html>