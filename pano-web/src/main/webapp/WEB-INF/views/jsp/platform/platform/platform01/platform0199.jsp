...
<script src="static/platform/platform/js/platform01/platform0199.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            ...
            <div class="card-body">
                <!-- 检索条件 -->
                <form:form id="platform0199FormSearch" action="/" modelAttribute="platform0199Form">
        ...
        <div id="toolbar" class="btn-group">
            <button id="platform0199Btn_new" type="button" class="btn pano-btn-danger">
    ...
    <!-- Ajax提交用的Form -->
    <form:form id="platform0199FormAjaxSubmit" action="/" modelAttribute="platform0199Form">
    </form:form>
</body>
</html>