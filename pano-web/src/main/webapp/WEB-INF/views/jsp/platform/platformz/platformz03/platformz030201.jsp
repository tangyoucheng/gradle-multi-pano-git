...
<script src="static/platform/platformz/js/platformz03/platformz030201.js"></script>
</head>
<body><!-- 工作量新增顶部Tool start -->
    ...
    <div class="card-body pt-6">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form:form action="/" modelAttribute="platformz030201Form" class="form-horizontal">
                    <!-- 值 -->
                    <div class="form-mb form-row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="txt_value" name="value"
                                value="${platformz030201Form.value}" maxlength="50" required="required">
                        </div>
                    </div>
                    <!-- 排序号 -->
                    <div class="mb-3 form-row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="txt_dispFlag" name="dispFlag"
                                value="${platformz030201Form.dispFlag}" maxlength="3" onblur="dispFlagFormat(this)">
                        </div>
                    </div>
                    <!-- 备注 -->
                    <div class="form-mb form-row">
                        ...
                        <div class="col-sm-4">
                             <textarea class="form-control" name="remark" rows="7" id="txt_remark" maxlength="100">${platformz030201Form.remark}</textarea>
                        </div>
                    </div>
                </form:form>
            </div>
