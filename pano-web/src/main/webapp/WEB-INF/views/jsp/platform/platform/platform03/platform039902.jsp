...
<script src="static/platform/platform/js/platform03/platform039902.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form action="/" modelAttribute="platform039902Form" class="form-horizontal">
                    <input type="hidden" name="editBeforeDataJson" value='${platform039902Form.editBeforeDataJson}'>
                    <!-- 公司Id -->
                    <input type="hidden" class="form-control" id="txt_companyId" name="companyId"
                        value="${platform039902Form.companyId}">
                    <!-- 公司名 -->
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txt_companyName" name="companyName"
                                value="${platform039902Form.companyName}" maxlength="255" required="required">
                        </div>
                    </div>
                    <div class="form-row">
