...
<script src="static/platform/platformz/js/platformz01/platformz019902.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form action="/" modelAttribute="platformz019902Form" class="form-horizontal">
                    <div class="form-group form-row">
                        <!-- 社区Id -->
                        <input type="hidden" class="form-control" id="txt_departmentId" name="departmentId"
                            value="${platformz019902Form.departmentId}">
                        <!-- 社区名 -->
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txt_departmentName" name=departmentName
                                value="${platformz019902Form.departmentName}" maxlength="255" required="required">
                        </div>
                        <!-- 上级社区名 -->
                        ...
                        <div class="col-sm-4">
                            <input type="hidden" class="form-control" id="txt_parentDepartmentId"
                                name="parentDepartmentId" value="${platformz019902Form.parentDepartmentId}" maxlength="200"
                                readonly="readonly">
                            <input type="text" class="form-control" id="txt_parentDepartmentName"
                                name="parentDepartmentName" value="${platformz019902Form.parentDepartmentName}"
