...
<script src="static/platform/platform/js/platform01/platform019901.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form action="/" modelAttribute="platform019901Form" class="form-horizontal">
                    <!-- 社区名 -->
                    <div class="form-group form-row">
                    
                    <input type="hidden" id="returnTargetIframe" name="returnTargetIframe"
                        value="${platform019901Form.returnTargetIframe }">
                        <!-- 社区层级 -->
                    <input type="hidden" name="departmentHierarchy" value="${platform019901Form.departmentHierarchy}" />
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txt_departmentName" name="departmentName"
                                value="${platform019901Form.departmentName}" maxlength="255" required="required">
                        </div>
                     <!-- 上级社区名 -->
                        ...
                        <div class="col-sm-4">
                            <input type="hidden" class="form-control" id="txt_parentDepartmentId" name="parentDepartmentId"
                                value="${platform019901Form.parentDepartmentId}" maxlength="200" readonly="readonly">
                            <input type="text" class="form-control" id="txt_parentDepartmentName" name="parentDepartmentName"
                                value="${platform019901Form.parentDepartmentName}" maxlength="200" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-row">
