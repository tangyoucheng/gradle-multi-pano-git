...
<script src="static/platform/platformz/js/platformz03/platformz030102.js"></script>
</head>
<body>
    <!-- 工作量新增顶部Tool start -->
    ...
    <div class="card-body pt-6">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form:form action="/" modelAttribute="platformz030102Form" class="form-horizontal">
                    <!-- Id -->
                    <input type="hidden" class="form-control" id="txt_serverTypeId" name="serverTypeId"
                        value="${platformz030102Form.serverTypeId}">
                    <!-- 值 -->
                    <div class="form-mb form-row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="txt_value" name="value"
                                value="${platformz030102Form.value}" maxlength="50" required="required">
                        </div>
                    </div>
                    <!-- 排序号 -->
                    <div class="form-mb form-row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="txt_dispFlag" name="dispFlag"
                                value="${platformz030102Form.dispFlag}" maxlength="3" onblur="dispFlagFormat(this)">
                        </div>
                    </div>
                    <!-- 备注 -->
                    <div class="form-mb form-row">
                        ...
                        <div class="col-sm-4">
                            <textarea class="form-control" name="remark" rows="7" id="txt_remark" maxlength="100">${platformz030102Form.remark}</textarea>
                        </div>
                    </div>
                </form:form>
            </div>
