...
<script src="static/platform/platformz/js/platformz02/platformz0299.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            ...
            <div class="card-body">
                <!-- 检索条件 -->
                <form:form id="platformz0299FormSearch" action="/" modelAttribute="platformz0299Form">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-auto">
                        <button type="button" id="platformz0299Btn_query" class="btn platform-btn-danger">
        ...
        <div id="toolbar" class="btn-group">
            <button id="platformz0299Btn_new" type="button" class="btn pano-btn-danger">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                <c:out value="新建"></c:out>
            </button>
            <button id="platformz0299Btn_delete" type="button" class="btn pano-btn-danger">
    ...
    <!-- Ajax提交用的Form -->
    <form:form id="platformz0299FormAjaxSubmit" action="/" modelAttribute="platformz0299Form">
    </form:form>
</body>
</html>