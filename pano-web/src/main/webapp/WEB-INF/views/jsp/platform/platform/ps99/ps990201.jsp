...
<script src="static/platform/platform/js/ps99/ps990201.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form modelAttribute="ps990201Form" class="form-horizontal">
                    <!-- 当前密码 -->
                    <div class="form-group form-row">
                        <label class="col-form-label text-right col-sm-1" for="txt_bankNameCn"> 当前密码 </label>
                        <div class="col-sm-3">
