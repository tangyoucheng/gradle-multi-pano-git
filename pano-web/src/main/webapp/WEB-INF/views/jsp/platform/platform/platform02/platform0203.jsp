...
<script src="static/platform/platform/js/platform02/platform0203.js"></script>
</head>
<body>
    <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-2">
                        <table id="roleList" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <c:forEach items="${platform0203Form.roleList }" var="roleItem" varStatus="roleItemStatus">
