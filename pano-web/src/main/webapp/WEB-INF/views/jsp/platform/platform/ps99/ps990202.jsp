...
<script src="static/platform/platform/js/ps99/ps990202.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form modelAttribute="ps990202Form" class="form-horizontal">
                    <div class="form-group form-row">
                        <div class="col-sm-12 text-right">
                            <img src="<%=request.getContextPath()%>/static/platform/platform/images/ps99/icon_time.gif" width="13"
                                height="13" />
