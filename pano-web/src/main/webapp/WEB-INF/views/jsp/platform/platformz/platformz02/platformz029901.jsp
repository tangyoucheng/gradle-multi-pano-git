...
<script src="static/platform/platformz/js/platformz02/platformz029901.js"></script>
</head>
<body>
    <div class="card-body">
        <div class="card card-default">
            <div class="card-body">
                <form:form action="/" modelAttribute="platformz029901Form" class="form-horizontal">
                    <!-- 角色名 -->
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txt_companyName" name="companyName"
                                value="${platformz029901Form.companyName}" maxlength="255" required="required">
                        </div>
                    </div>
                    <div class="form-row">
