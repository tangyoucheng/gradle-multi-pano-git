...
<script src="static/platform/platformz/js/platformz01/platformz010203.js"></script>
</head>
<body>
    <div class="card-body">
        <!-- 检索条件 -->
        <form:form id="platformz010203FormSearch" action="/" modelAttribute="platformz010203Form">
            <input type="hidden" id="returnTargetIframe" name="returnTargetIframe" value="${returnTargetIframe }">
        </form:form>
        <div id="toolbar" class="btn-group">
            <button id="platformz010203Btn_selected" type="button" class="btn pano-btn-danger">
