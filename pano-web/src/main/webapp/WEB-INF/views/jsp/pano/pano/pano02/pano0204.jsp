...
<head>
<pano:head></pano:head>
<script src="static/pano/pano/js/pano02/pano0204.js"></script>
...
<body>
    ...
    <!-- Ajax提交用的Form -->
    <form:form id="pano0204FormAjaxSubmit" action="/" modelAttribute="pano0204Form">
        <input type="hidden" name="expositionId" value="${pano0204Form.expositionId}" />
        <input type="hidden" name="currentPanoramaId" value="${pano0204Form.currentPanoramaId}" />
        <input type="hidden" name="selectedHotspotId" value="${pano0204Form.selectedHotspotId}" />
    </form:form>
</body>
<!-- 预览全景图 -->
<div id="pano0204OpenLayer" title="预览" class="text-center" style="display: none;">
    <div class="form-group col-sm-12 d-flex align-items-center align-content-center">
        <div id="pano0204Pano" style="width: 100%; height: 300px;"></div>
    </div>
</div>
</html>