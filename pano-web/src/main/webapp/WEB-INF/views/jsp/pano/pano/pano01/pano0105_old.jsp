...
<%@ page import="cn.com.cdic.form.pano01.Pano0105Form"%>
...
<script src="cdic/js/pano01/pano0105.js"></script>
...
<div class="imui-title">
    ...
    <div class="imui-form-container" style="width:95%">
       <!-- 自定义工具条设定 -->
    <imui:dialog id="pano0105SetToolFinish" modal="true" autoOpen="false" >
       ...
       <imui:dialog id="pano0105Finish" modal="true" autoOpen="false" onClose="closeDialog();">
            <div class="imui-form-container-narrow" style="border: none;">
                <h2>设定成功！</h2>
                <div class="imui-operation-parts">
        ...
        <imui:dialog id="pano0105SetLayerFinish" modal="true" autoOpen="false" onClose="closeDialog();">
            <div class="imui-form-container-narrow" style="border: none;">
                <h2>浮动信息位置设定成功！</h2>
                <div class="imui-operation-parts">
        ...
        <imui:dialog id="pano0105FlowInfoCommandChoice" title="浮动信息种类选择" modal="true" autoOpen="false" width="220">
        ...
        <imui:dialog id="pano0105FlowInfoEidtChoice" title="浮动信息操作选择" modal="true" autoOpen="false" width="220">
            <div class="imui-operation-parts" style="margin-left:30px;text-align: left;">
        ...
        <form id="pano0105Form" action="pano01/pano0105"  method="post">
            <input type="hidden" name="expositionId" id="expositionId" value='${expositionId}' />
            <input type="hidden" name="positionAthForEdit" id="pano0105positionAthForEdit" value="${positionAthForEdit}"/>
            <input type="hidden" name="positionAtvForEdit" id="pano0105positionAtvForEdit" value="${positionAtvForEdit}"/>
            ...
            <input type="hidden" name="theLastedSceneHotspotId"  id="pano0105lastHotspotId" value="${theLastedSceneHotspotId}"/>
            <input type="hidden" name="currentRecommendHotspotId" id="pano0105CurrentHotspotId" value="${currentRecommendHotspotId}"/>
            
            <table class="imui-form">
                  <tr>
                     <th style="width: 20%;"><label>当前场景名称 :</label></th>
                     <td style="width: auto%;"><label  id="pano0105title">${panoramaName}</label></td>
                 </tr>
             </table>
...
<form id="back-form" method="POST" action="pano01/pano0104/doSearchFromPano0105">
    <input type="hidden" name="panoramaId"  value="${panoramaId}"/>
    <input type="hidden" name="positionAthForEdit" id="pano0105BackAth" value="${positionAthForEdit}"/>
    <input type="hidden" name="positionAtvForEdit" id="pano0105BackAtv" value="${positionAtvForEdit}"/>
...
<!-- 前往导航图编辑画面 -->
<form id="edit-map" method="POST" action="pano01/pano0106">
    <input type="hidden" name="panoramaId"  value="${panoramaId}"/>
    <input type="hidden" name="expositionId"  value="${expositionId}"/>
...
<!-- 前往导航图上热点编辑画面 -->
<form id="edit-hotspot" method="POST" action="pano01/pano0107">
    <input type="hidden" name="panoramaId"  value="${panoramaId}"/>
    <input type="hidden" name="expositionId"  value="${expositionId}"/>
    <input type="hidden" name="expositionName"  value="${expositionName}"/>
    <input type="hidden" name="theLastedSceneHotspotId"  value="${theLastedSceneHotspotId}"/>
...
<!-- 通过导航图上的热点前往场景画面 -->
<form id="go-to-pano0104-panorama" method="POST" action="pano01/pano0104/doShowHostspotInfoFromMiniMap">
